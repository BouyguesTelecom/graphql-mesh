...
Instead of `@graphql-mesh/cli`, you should now use `@bouygues-telecom/graphql-compose-cli` and
...
npm install @bouygues-telecom/graphql-compose-cli @graphql-hive/gateway
```
