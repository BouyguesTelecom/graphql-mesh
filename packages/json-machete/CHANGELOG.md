...
- 331b62637: fix(@bouygues-telecom/graphql-json-machete): Heal generated schemas
- 331b62637: fix(@bouygues-telecom/graphql-json-machete): if anyOf/oneOf/allOf is singular, use that single value directly
...
- d64c74b75: fix(@bouygues-telecom/graphql-json-machete): ignore null values in dereferenceObject

## 0.7.7

### Patch Changes

- 114629e47: fix(@bouygues-telecom/graphql-json-machete): respect int64 types
...
- c53203723: fix(@bouygues-telecom/graphql-json-machete): revert old behavior

## 0.7.2

### Patch Changes

- c6f0314ac: fix(@bouygues-telecom/graphql-json-machete): use util back
...
- b45dac0c0: feat(@bouygues-telecom/graphql-json-machete): add missing format if example is provided
...
- ca6bb5ff3: fix(@bouygues-telecom/graphql-json-machete): respect items prop in object type
...
- 49e9ca808: feat(@bouygues-telecom/graphql-json-machete): trim descriptions
...
- 020431bdc: enhance(@bouygues-telecom/graphql-json-machete): do not look for annotated schemas
...
- d907351c5: fix(@bouygues-telecom/graphql-json-machete): respect object.items pattern
...
- 3bded2bad: fix(@bouygues-telecom/graphql-json-machete): stringify circular objects correctly to compare for deduplicating
  schema
